...
rm = RoundsManager(input_path="./CoBeHumanExperimentsData", output_path="./database")
...
rm.write_bout_info(exp_args=exp_args, exp_plotter_args=exp_plotter_args, with_plots=False, with_csv=False, with_hdf5=True)
